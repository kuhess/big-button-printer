...
class Tprinter : public Print {
 private:
  ...
  static bool getPixel(const uint8_t *bitmap, uint16_t width, uint16_t height, uint16_t x, uint16_t y);
 ...
 public:
  ...
  void feed(uint8_t n = 1),                     // feed n lines
      ...
      printBitmap2(const uint8_t *bitmap, uint16_t width, uint16_t height),
